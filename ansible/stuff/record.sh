...
tmux new -s "ffmpeg" -d; 
tmux send-keys 'su -c "sleep 5m; ffmpeg -y -f pulse -ac 2 -i "auto_null.monitor" -framerate 15 -f x11grab -draw_mouse 0 -s 1920x1080 -i :99 -c:v libx265 -crf 35 -preset fast /home/yolo/reg.mkv" yolo -' C-m;
